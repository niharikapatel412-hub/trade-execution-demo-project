...
import com.example.order.management.client.*;
import com.example.order.management.models.*;
...
public class OrderService {
    ...
    public FixOrder getAllOrders() {
        // For simplicity, return the first order in the map
